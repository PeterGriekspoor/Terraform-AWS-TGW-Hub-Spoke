...
until curl \
    ...
    --url https://hol4geocluster.s3.us-east-2.amazonaws.com/img/cp-main-pic-9-1168x657.jpg ; do
    sleep 1
done
sudo chmod a+w /var/www/html/index.html
echo "<html><head></head><body><center><H1>" > /var/www/html/index.html
echo $HOSTNAME >> /var/www/html/index.html
echo "<BR><BR>Edge VPC - Welcome to Check Point Headquarters <BR> The view is amazing!<BR><BR>" >> /var/www/html/index.html
